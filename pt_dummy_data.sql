...
VALUES
    ...
    #neue Dozenten
    ('yhawtry0@wikipedia.org', 'Yolanda', 'Hawtry'),
	('pspon1@constantcontact.com', 'Patrice', 'Spon'),
	('awayne2@google.nl', 'Ashlen', 'Wayne'),
	('kmacritchie3@mlb.com', 'Krishnah', 'MacRitchie'),
    #Studenten
    #WI C
...
#Etechnik Studenten
	('igwyther0@nature.com', 'Iolande', 'Gwyther'),
	('rscarth1@google.com.br', 'Revkah', 'Scarth'),
	('gburdess2@vk.com', 'Gib', 'Burdess'),
	('eheggadon3@alibaba.com', 'Ethan', 'Heggadon'),
	('jmichelle4@cnbc.com', 'Jeane', 'Michelle'),
	('bhelks5@nps.gov', 'Barbe', 'Helks'),
	('dwilce6@twitter.com', 'Dukey', 'Wilce'),
	('adellenbrok7@youtube.com', 'Andrea', 'Dellenbrok'),
	('spagram8@sogou.com', 'Sanderson', 'Pagram'),
	('cjickells9@wp.com', 'Caryn', 'Jickells'),
	('cworsnupa@sitemeter.com', 'Catrina', 'Worsnup'),
	('pstilingb@nydailynews.com', 'Pearline', 'Stiling'),
	('mwathanc@plala.or.jp', 'Maia', 'Wathan'),
	('btideyd@marketwatch.com', 'Breanne', 'Tidey'),
	('nrosenhause@ustream.tv', 'Nicolas', 'Rosenhaus'),
	('jgabef@google.co.uk', 'Jamie', 'Gabe');
...
VALUES
    ...
    ('yhawtry0@wikipedia.org'),
	('pspon1@constantcontact.com'),
	('awayne2@google.nl'),
	('kmacritchie3@mlb.com');

INSERT INTO student (fk_mail, fk_fachrichtung, matnr)
VALUES
	#Etechnik
	('igwyther0@nature.com', 'Etechnik', '711110'),
	('rscarth1@google.com.br', 'Etechnik', '711111'),
	('gburdess2@vk.com', 'Etechnik', '711112'),
	('eheggadon3@alibaba.com', 'Etechnik', '711113'),
	('jmichelle4@cnbc.com', 'Etechnik', '711114'),
	('bhelks5@nps.gov', 'Etechnik', '711115'),
	('dwilce6@twitter.com', 'Etechnik', '711116'),
	('adellenbrok7@youtube.com', 'Etechnik', '711117'),
	('spagram8@sogou.com', 'Etechnik', '711118'),
	('cjickells9@wp.com', 'Etechnik', '711119'),
	('cworsnupa@sitemeter.com', 'Etechnik', '711120'),
	('pstilingb@nydailynews.com', 'Etechnik', '711121'),
	('mwathanc@plala.or.jp', 'Etechnik', '711122'),
	('btideyd@marketwatch.com', 'Etechnik', '711123'),
	('nrosenhause@ustream.tv', 'Etechnik', '711124'),
	('jgabef@google.co.uk', 'Etechnik', '711125'),
    #WI Kurs C
    ('stud.darth.vader@hwr.de', 'WI', 511126),
    ('stud.indiana.jones@hwr.de', 'WI', 511127),
    ('stud.rocky.balboa@hwr.de', 'WI', 511128),
    ('stud.vito.corleone@hwr.de', 'WI', 511129),
    ('stud.princess.leia@hwr.de', 'WI', 511130),
    ('stud.scarlett.ohara@hwr.de', 'WI', 511131),
    ('stud.the.joker@hwr.de', 'WI', 511132),
    ('stud.hannibal.lector@hwr.de', 'WI', 511133),
    ('stud.tony.montana@hwr.de', 'WI', 511134),
    ('stud.mary.poppins@hwr.de', 'WI', 511135),
    ('stud.black.widow@hwr.de', 'WI', 511136),
    ('stud.cosmo.cramer@hwr.de', 'WI', 511137),
    ('stud.ellen.ripley@hwr.de', 'WI', 511138),
    ('stud.marge.simpson@hwr.de', 'WI', 511139),
    ('stud.mutti@hwr.de', 'WI', 511140),
    #WI Kurs A
    ('stud.captain.america@hwr.de', 'WI', 511141),
    ('stud.greta.thunberg@hwr.de', 'WI', 511142),
    ('stud.fauler.sack@hwr.de', 'WI', 511143),
    ('stud.super.streber@hwr.de', 'WI', 511144),
    ('stud.über.schätzt@hwr.de', 'WI', 511145),
    ('mcopin0@spiegel.de', 'WI', 511146),
    ('sbangs1@fastcompany.com', 'WI', 511147),
    ('aellacombe2@skyrock.com', 'WI', 511148),
    ('ayerrall3@yahoo.co.jp', 'WI', 511149),
    ('jmatley4@weebly.com', 'WI', 511150),
    ('zsabey5@businesswire.com', 'WI', 511151),
    ('lhinkens6@furl.net', 'WI', 511152),
    ('bhellewell7@1und1.de', 'WI', 511153),
    ('zsanton8@tinypic.com', 'WI', 511154),
    ('mspark9@ucoz.com', 'WI', 511155),
    #BWL
    ('asaigera@cargocollective.com', 'BWL', 611156),
    ('tclixbyb@state.tx.us', 'BWL', 611157),
    ('ahairec@amazon.com', 'BWL', 611158),
    ('idenisotd@themeforest.net', 'BWL', 611159),
    ('dmore@dailymail.co.uk', 'BWL', 611160),
    ('tbranef@prweb.com', 'BWL', 611161),
    ('gbanaszczykg@wordpress.org', 'BWL', 611162),
    ('wdmitrh@flavors.me', 'BWL', 611163),
    ('dedwickei@nih.gov', 'BWL', 611164);
...
VALUES
    ('grd', 'doz.super.man@hwr.de', 1),
    ('krd', 'doz.micky.mouse@hwr.de', 2),
    ('krw', 'doz.james.bond@hwr.de', 3),
    ('krd', 'doz.james.bond@hwr.de', 4),
    ('krd', 'doz.bugs.bunny@hwr.de', 5),
    ('krd', 'doz.dorothy.gale@hwr.de', 6),
    ('grd', 'doz.super.man@hwr.de', 7),
    ('krd', 'doz.micky.mouse@hwr.de', 8),
    ('krw', 'doz.james.bond@hwr.de', 9),
    ('krd', 'doz.james.bond@hwr.de', 10),
    ('krd', 'doz.bugs.bunny@hwr.de', 11),
    ('krd', 'doz.dorothy.gale@hwr.de', 12),
	('krd', 'doz.dorothy.gale@hwr.de', 13),
    ('krd', 'yhawtry0@wikipedia.org', 14),
    ('krd', 'pspon1@constantcontact.com', 15),
    ('krd', 'awayne2@google.nl', 16),
    ('krd', 'kmacritchie3@mlb.com', 17);
...
#neue doz und neue studenten fehlen
    ...
    ('yhawtry0@wikipedia.org', 'e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855'),
	('pspon1@constantcontact.com', '7930035759caad0d6502908dd93d80ee6127121b1c404fa72d227e409d2aa720'),
	('awayne2@google.nl', 'd9c64ce420476f82982214e25b785427c7c3e5f62c9f798ac20eb2a423673127'),
	('kmacritchie3@mlb.com', 'fa16dba3e305ace8414f3b7d5184e2942cc7e21dc7318188e310bdb08fd9cbd3'),
	('igwyther0@nature.com', '09e07ccb003ee188a4ea239f7d45c9dc148b88de3596a5ef01dcf9d47cfb498d'),
	('rscarth1@google.com.br', '3bece569d5f4b3e9d9369da0b4a4c1ab59badf50e83f43d360296c53bf7d0f3d'),
	('gburdess2@vk.com', '372b8961715c1fcac1152ce5fd5d6e1045301e7500bf6f00f5f09329b9c241b2'),
	('eheggadon3@alibaba.com', '2c488fbf229cfa3ea44313dd472dd112a96d2a0a77aadf5ff1279640496b324a'),
	('jmichelle4@cnbc.com', '9f64bea4eeea8912fe14047c75278a66a2f7c760daa9324e468b1c49811a05d2'),
	('bhelks5@nps.gov', '5a2e7df870292c3a642a6101b74592c7c5063c1d799194dc8959ec1212375296'),
	('dwilce6@twitter.com', '2c45bd2be9cd5ce11dace52ebe6d8fc1197470d392420fe222f757581e1944df'),
	('adellenbrok7@youtube.com', 'bd0cc4dca91adf16f4beaa9461eaee9cbc230fe57ef712535f37b3dca073ed69'),
	('spagram8@sogou.com', 'c7828d7d7307d6014178be482b73234e55d0ccc31d7a0b44f350a965d0ab4fb0'),
	('cjickells9@wp.com', '35106dc12dfcef37e2d877f10df92a7336632e41fe22d9b564786d5a2358bc91'),
	('cworsnupa@sitemeter.com', '1c6cdd173dbb7288dfc6e83b9e5d78af7c1653f3fa97065bf38f47299b59f7af'),
	('pstilingb@nydailynews.com', '67a0c5bbfd865fdecaa5aab7c4c8ce99d122492120d0d2b02709a941811b6769'),
	('mwathanc@plala.or.jp', 'c0f41b43b256a0db15c7edff37f66ddb7d26c8b35c6b4ce14dded0c275e1eabb'),
	('btideyd@marketwatch.com', '95e3fac9ac5e7b39dadda55367cd5ce1ccc878274de49549bfcb8e8f36bca3b9'),
	('nrosenhause@ustream.tv', '497b4315737f161ceb1d8188f7bdf10cca77ae699cf3195125a67fab893ac26c'),
	('jgabef@google.co.uk', 'fee5e31f3d3728be1a44be0a35da1111ae2d4f78adeb33cb54f1ec1821ec2e61');
