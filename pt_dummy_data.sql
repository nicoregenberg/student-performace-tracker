...
VALUES
    1(STR_TO_DATE('01.10.21','%d.%m.%y'), 2, 1, 3),
    ...
    10(STR_TO_DATE('10.11.21','%d.%m.%y'), 3, 1, 1),
    ...
    20(STR_TO_DATE('12.10.21','%d.%m.%y'), 6, 2, 1),
    ...
    (STR_TO_DATE('18.11.21','%d.%m.%y'), 6, 2, 1),
    (STR_TO_DATE('18.11.21','%d.%m.%y'), 6, 2, 1),
    30(STR_TO_DATE('25.11.21','%d.%m.%y'), 6, 2, 1),
    ...
    40(STR_TO_DATE('10.12.21','%d.%m.%y'), 4, 5, 1),
    ...
    50(STR_TO_DATE('29.11.21','%d.%m.%y'), 1, 7, 6),
    ...
    60(STR_TO_DATE('28.10.21','%d.%m.%y'), 2, 8, 1),
    ...
    70(STR_TO_DATE('05.12.21','%d.%m.%y'), 7, 9, 1),
...
VALUES
    ...
    (223340, 1.0, 41, STR_TO_DATE('02.10.21 11:11','%d.%m.%y %H:%i'), 0, 1, false),
    (223340, 2.0, 45, STR_TO_DATE('01.11.21 23:59','%d.%m.%y %H:%i'), 0, 1, false),
    (223340, 1.5, 52, STR_TO_DATE('01.12.21 00:01','%d.%m.%y %H:%i'), 1, 1, false),
    (223340, 3.0, 59, STR_TO_DATE('01.11.21 00:01','%d.%m.%y %H:%i'), 0, null, false),
    (223343, 3.7, 42, STR_TO_DATE('01.12.21 00:01','%d.%m.%y %H:%i'), 0, null, false),
    (223343, 2.0, 44, STR_TO_DATE('01.10.21 11:11','%d.%m.%y %H:%i'), 0, 1, false),
    (223343, 2.3, 52, STR_TO_DATE('02.11.21 23:59','%d.%m.%y %H:%i'), 0, 1, false),
    (223343, 1.0, 58, STR_TO_DATE('01.12.21 00:01','%d.%m.%y %H:%i'), 1, 1, false),
    (223346, 2.0, 43, STR_TO_DATE('01.11.21 00:01','%d.%m.%y %H:%i'), 0, null, false),
    (223346, 1.7, 48, STR_TO_DATE('01.12.21 00:01','%d.%m.%y %H:%i'), 0, null, false),
    ...
    (223341, 1.5, 38, STR_TO_DATE('01.12.21 00:01','%d.%m.%y %H:%i'), 1, 1, false),
    (223341, 3.0, 44, STR_TO_DATE('01.11.21 00:01','%d.%m.%y %H:%i'), 0, null, false),
    (223341, 3.7, 64, STR_TO_DATE('01.12.21 00:01','%d.%m.%y %H:%i'), 0, null, false),
    (223341, 2.0, 71, STR_TO_DATE('01.10.21 11:11','%d.%m.%y %H:%i'), 0, 1, false),
    (223344, 2.3, 39, STR_TO_DATE('02.11.21 23:59','%d.%m.%y %H:%i'), 0, 1, false),
    (223344, 1.0, 45, STR_TO_DATE('01.12.21 00:01','%d.%m.%y %H:%i'), 1, 1, false),
    (223344, 2.0, 66, STR_TO_DATE('01.11.21 00:01','%d.%m.%y %H:%i'), 0, null, false),
    (223344, 1.7, 72, STR_TO_DATE('01.12.21 00:01','%d.%m.%y %H:%i'), 0, null, false),
    ...
    (223342, 1.5, 50, STR_TO_DATE('01.12.21 00:01','%d.%m.%y %H:%i'), 1, 1, false),
    (223342, 3.0, 63, STR_TO_DATE('01.11.21 00:01','%d.%m.%y %H:%i'), 0, null, false),
    (223342, 3.7, 65, STR_TO_DATE('01.12.21 00:01','%d.%m.%y %H:%i'), 0, null, false),
    (223342, 2.0, 74, STR_TO_DATE('01.10.21 11:11','%d.%m.%y %H:%i'), 0, 1, false),
    (223345, 2.3, 52, STR_TO_DATE('02.11.21 23:59','%d.%m.%y %H:%i'), 0, 1, false),
    (223345, 1.0, 57, STR_TO_DATE('01.12.21 00:01','%d.%m.%y %H:%i'), 1, 1, false),
    (223345, 2.0, 66, STR_TO_DATE('01.11.21 00:01','%d.%m.%y %H:%i'), 0, null, false),
    (223345, 1.7, 73, STR_TO_DATE('01.12.21 00:01','%d.%m.%y %H:%i'), 0, null, false),
	(223348, 1.0, 53, STR_TO_DATE('02.10.21 11:11','%d.%m.%y %H:%i'), 0, 1, false),
    (223348, 2.0, 58, STR_TO_DATE('01.11.21 23:59','%d.%m.%y %H:%i'), 0, 1, false),
    (223348, 1.5, 68, STR_TO_DATE('01.12.21 00:01','%d.%m.%y %H:%i'), 1, 1, false),
    (223348, 3.0, 72, STR_TO_DATE('01.11.21 00:01','%d.%m.%y %H:%i'), 0, null, false),
    (223349, 3.7, 55, STR_TO_DATE('01.12.21 00:01','%d.%m.%y %H:%i'), 0, null, false),
